...
//            List<Future<Integer>> futureList = fixedPool.invokeAll(callableList);
    ...
    public static void inmultireaADouaMatrici() {
        Scanner scanner = new Scanner(System.in);
        String path = "fisier1.txt", path2 = "fisier2.txt";
        ...
        nr_of_elements = n * m;
        try {
            Matrix.writeGeneratedMatrixToFile(path, n, k);
            Matrix.writeGeneratedMatrixToFile(path2, k, m);
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//            List<Callable<Matrix>> callableList = new LinkedList<>();
//            int blocks = matrix1.getRows() / nr_of_threads, start_row = 0, end_row = 0;
...
//                    end_row = blocks * i;
//                    final int s = start_row, f = end_row;
//                    Callable<Matrix> callable1 = new Callable<Matrix>() {
//                        @Override
//                        public Matrix call() throws Exception {
//                            //matrix1.parallel_addition(matrix2, s, f);
//                            rez.parallel_multiply(matrix1, matrix2, s, f);
//                            return rez;
//                        }
//                    };
//                    callableList.add(callable1);
...
//                }
//            }
//            List<Future<Matrix>> futureList = fixedPool.invokeAll(callableList);
            ...
            System.out.println("Time multiplication (ms)" + TimeUnit.MILLISECONDS.convert(elapsedTime, TimeUnit.NANOSECONDS));
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("2 - inmultirea");
